...
3. Complete the profile questionnaire:
   ...
   ![Developer Program Signup — Profile](media/Pasted%20image%2020260507172108.png)
   ![Developer Program — Focus Areas](media/Pasted%20image%2020260507172127.png)
   ![Developer Program — Interests](media/Pasted%20image%2020260507172135.png)
   ![Developer Program — Phone Verification](media/Pasted%20image%2020260507172145.png)

4. After verification, the tenant dashboard loads. The subscription is provisioned automatically.

   ![Developer Program — Welcome Dashboard](media/Pasted%20image%2020260507172213.png)
...
3. Configure sign-in details:
   ...
   ![Business Premium — Trial Selection](media/Pasted%20image%2020260507172242.png)
   ![Business Premium — Sign-in Details](media/Pasted%20image%2020260507172258.png)
   ![Business Premium — Account Setup](media/Pasted%20image%2020260507172306.png)
   ![Business Premium — Organisation Details](media/Pasted%20image%2020260507172316.png)
   ![Business Premium — Username Configuration](media/Pasted%20image%2020260507172343.png)

4. Review the order summary and confirm. The tenant is now dual-licenced (E5 Developer + Business Premium).

   ![Business Premium — Order Review](media/Pasted%20image%2020260507172356.png)
   ![Business Premium — Confirmation](media/Pasted%20image%2020260507172410.png)
...
4. Confirm the Authenticator is added and set as the default sign-in method.
   ...
   ![MFA Setup — Add Security](media/Pasted%20image%2020260507172423.png)
   ![MFA Setup — Install Authenticator](media/Pasted%20image%2020260507172434.png)
   ![MFA Setup — Configure in App](media/Pasted%20image%2020260507172443.png)
   ![MFA Setup — Scan QR Code](media/Pasted%20image%2020260507172452.png)
   ![MFA Setup — Authenticator Added](media/Pasted%20image%2020260507172501.png)
   ![MFA Setup — Stay Signed In](media/Pasted%20image%2020260507172512.png)

5. Sign in to the **Microsoft 365 admin center** (`admin.microsoft.com`) to verify tenant health.

   ![Admin Center — First Login](media/Pasted%20image%2020260507172522.png)
   ![Admin Center — Dashboard](media/Pasted%20image%2020260507172531.png)
